...
<div id="a2" style="position:absolute;top:30px;left:250px" class="c">
	<form name="f1" action="<%=request.getContextPath()%>/UpdateFile?fileId=<%=fileId%>" method="post" enctype="multipart/form-data">
	<table id="login" align="center">
		...
		<tr align="center">
			<td align="center" colspan="3">
					<input type="submit" class="button" value="Update Image" onclick="return check();"></input>
			</td>
	    </tr>
