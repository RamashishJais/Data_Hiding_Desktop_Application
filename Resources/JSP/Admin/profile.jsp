...
%>
			<br>
			<div align="right" style="position:absolute;top:25px;left:500px">
			...
			<br>
			<div id="a2" align="right" style="position:absolute;top:50px;left:150px;">
...
<!-- Display Contents (Starts) -->
					...
					<br></br>
					<div id="a2" align="right" style="position:absolute;top:40px;left:150px">
...
%>
      <form id="login" action="<%=request.getContextPath() %>/ChangePass?no=2">
		...
		<input type="hidden" name="id" value="<%=id %>"></input>
		<input type="hidden" name="no" value="2"></input>
		<div align="right" style="position:absolute;top:20px;left:500px">
			<a class="gradientbuttons" href="<%=request.getContextPath() %>/EditProfile?username=<%=username%>&no=1">Edit Profile</a>
			<input type="submit" value="Save Updates" class="gradientbuttons"/>&nbsp;&nbsp;&nbsp;&nbsp;
		</div>
		<br></br>
		
		<div id="a2" align="right" style="position:absolute;top:60px;left:150px">
				<p>
					<table>
							<tr>
									<td colspan="3" align="center">
