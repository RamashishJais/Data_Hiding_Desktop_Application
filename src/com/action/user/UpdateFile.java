	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException
     ...
     if(ok)
     {
    	 ...
    	 try 
    	 {
			 ...
			 if(!flag)
			 {
				 String file_name = userDAO.getFileName(fileId);
				 String fpath = request.getRealPath("") +"\\Files\\Image\\" +file_name;
				 File file = new File(fpath);
				 
				 flag = userDAO.updateFile(fileId,img_name);
    	 ...
    	 {
			System.out.println("Opps Exception in UpdateFile Servlet : ");
			e.printStackTrace();
		 }
